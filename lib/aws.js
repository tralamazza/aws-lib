...
var genericAWSClient = function(obj) {
  ...
  obj.addStandardAWSSignature = obj.addStandardAWSSignature || true;
  obj.addXAMZNAuthorization = obj.addXAMZNAuthorization || false;
  obj.addAuthorizationHeader = obj.addAuthorizationHeader || false;
  ...
  obj.call = function (action, query, callback) {
    ...
    if (obj.addStandardAWSSignature) {
    ...
    if (obj.addAuthorizationHeader) {
      var auth_sign = crypto.createHmac("sha1", obj.secretAccessKey).update(now.toUTCString()).digest("base64");
